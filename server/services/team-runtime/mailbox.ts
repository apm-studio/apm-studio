/**
 * mailbox.ts — Mailbox state management for Team Thread runtime
 *
 * PRD §6: Mailbox is the internal SoT for all Team collaboration state.
...
export class Mailbox {
    ...
    markDelivered(messageId: string): void {
        ...
        if (idx !== -1) {
            // After delivery, message lives in agent's session — remove from mailbox
