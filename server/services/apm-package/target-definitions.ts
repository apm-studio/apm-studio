...
const TARGET_DEFINITION_RULES: Record<ApmSyncTargetId, TargetDefinitionRule[]> = {
    ...
    claude: [
        ...
        { dir: '.claude/instructions', kind: 'instruction', syncUnit: 'instructions', maxDepth: 2, extensions: ['.md'] },
        { files: ['.claude/CLAUDE.md'], kind: 'instruction', syncUnit: 'instructions' },
    ...
    copilot: [
        ...
        { dir: '.agents/skills', kind: 'skill', syncUnit: 'skills', maxDepth: 3, basenames: ['SKILL.md'], extensions: ['.md'] },
        { files: ['.github/mcp.json'], kind: 'mcp', syncUnit: 'mcp' },
    ],
    gemini: [
        ...
        { files: ['.gemini/settings.json', '.gemini/mcp.json'], kind: 'mcp', syncUnit: 'mcp' },
    ],
    'agent-skills': [
        { dir: '.agents/skills', kind: 'skill', syncUnit: 'skills', maxDepth: 3, basenames: ['SKILL.md'], extensions: ['.md'] },
    ],
