...
export const SOURCE_ADAPTERS: SourceAdapter[] = [
    ...
    {
        id: 'composio-agent-orchestrator',
    ...
    {
        id: 'khazp-vibe-coding-prompt-template',
        name: 'Vibe Coding Prompt Template',
        owner: 'KhazP',
        repo: 'vibe-coding-prompt-template',
    ...
    {
        id: 'lst97-claude-code-sub-agents',
        name: 'Claude Code Sub Agents',
        owner: 'lst97',
        repo: 'claude-code-sub-agents',
        href: 'https://github.com/lst97/claude-code-sub-agents',
        kind: 'preset',
        stars: 1_578,
    },
    {
        ...
        owner: 'hesreallyhim',
        repo: 'awesome-claude-code-agents',
        href: 'https://github.com/hesreallyhim/awesome-claude-code-agents',
        kind: 'preset',
        stars: 1_263,
    },
]
