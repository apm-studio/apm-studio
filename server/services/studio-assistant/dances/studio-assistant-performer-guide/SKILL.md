...
- Load `studio-assistant-tal-design-guide` when writing or revising Instruction.
...
- If a new Agent needs a local Skill, prefer inline `addDanceDrafts` or a same-call Skill draft ref.
...
- Stuffing whole workflow choreography into Agent Instruction instead of Team rules and relations.
