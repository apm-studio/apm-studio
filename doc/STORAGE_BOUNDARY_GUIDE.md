...
- this is the canonical package boundary for agents, instructions, skills, MCP requirements, prompts, commands, hooks, and external target sync. Studio-only model selection is runtime/editor state and must not be injected into target artifacts.
