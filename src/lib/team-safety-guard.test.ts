...
import { SafetyGuard } from '../../server/services/team-runtime/safety-guard.js'
import type { TeamThread } from '../../shared/team-types'
...
describe('SafetyGuard thread timeout', () => {
    ...
    it('respects an explicit thread timeout from team safety', () => {
        const guard = SafetyGuard.fromTeamSafety({ threadTimeoutMs: 1_000 })
        const thread: TeamThread = {
            id: 'thread-1',
            teamId: 'team-1',
            mailbox: {
