import type { WorkspaceMarkdownEditorKind } from '../../../shared/workspace-contracts'
...
export function markdownEditorModeConfig(kind: WorkspaceMarkdownEditorKind): MarkdownEditorModeConfig {
    if (kind === 'skill') {
        return {
            title: 'Skill Editor',
