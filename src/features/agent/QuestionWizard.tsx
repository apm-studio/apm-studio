...
import type { ChatQuestionAnswer, ChatQuestionRequest } from '../../../shared/chat-contracts';
import { HelpCircle, Check, X, ChevronRight, ChevronLeft } from 'lucide-react';
import './InteractionDock.css';

interface QuestionWizardProps {
    request: ChatQuestionRequest;
    onRespond: (answers: ChatQuestionAnswer[]) => void;
    onReject: () => void;
    responding: boolean;
}
...
export default function QuestionWizard({ request, onRespond, onReject, responding }: QuestionWizardProps) {
    ...
    const [answers, setAnswers] = useState<ChatQuestionAnswer[]>(() => (request.questions || []).map(() => []));
