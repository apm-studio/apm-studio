...
export type AgentComposeCardItem = {
    key: string
    label: string
...
type AgentComposeCardsProps = {
    cards: AgentComposeCard[]
    footer?: ReactNode
    hidden?: boolean
}

export default function AgentComposeCards({
    cards,
    footer,
    hidden = false,
}: AgentComposeCardsProps) {
    return (
