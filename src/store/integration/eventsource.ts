 ...
 *
 * Each EventSource stream (chat, team-runtime, and similar managed feeds) follows the same
...
export interface EventSourceSlot {
    ...
    /** Optional extra key (e.g. teamSessionId) used by team stream. */
...
export interface ReconnectOptions {
    ...
    /** Resolve optional extra key from app state (e.g. teamSessionId). */
 ...
 * (e.g. after creating a new safe-mode agent session) but the
